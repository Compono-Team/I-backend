...
public class TimeLineService {
  ...
  public ScheduleTime createScheduleTimeStart(Long scheduleId){
  ...
  public ScheduleTime updateScheduleTimeStop(Long scheduleTimeId){
    LocalDateTime now=LocalDateTime.now();
  ...
  public List<ScheduleWithScheduleTimeDTO> findScheduleTimeWithinRange(Long userId, LocalDateTime time,int n){
