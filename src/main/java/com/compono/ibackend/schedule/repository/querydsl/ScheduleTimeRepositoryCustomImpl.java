...
public class ScheduleTimeRepositoryCustomImpl extends QuerydslRepositorySupport
        implements ScheduleTimeRepositoryCustom {
    ...
    @Override
    public List<ScheduleWithScheduleTimeDTO> findWithinTimeRangeByUserId(
        ...
        return from(qScheduleTime)
                .select(
                        Projections.constructor(
                                ScheduleWithScheduleTimeDTO.class, qScheduleTime, qSchedule))
                        ...
                        qSchedule
                                ...
                                .and(
                                        qScheduleTime
                                                ...
                                                .or(
                                                        qScheduleTime.stopTime.between(
                                                                startTime, endTime))))
                .fetch();
    }
}
